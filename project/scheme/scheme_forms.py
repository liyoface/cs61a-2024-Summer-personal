...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # BEGIN PROBLEM 4
        "*** YOUR CODE HERE ***"
        value = scheme_eval(expressions.rest.first, env)  # Evaluate the expression
        ...
        lambda_expr = Pair("lambda",Pair(signature.rest, expressions.rest))
        env.define(name, scheme_eval(lambda_expr,env))
        return name
        # END PROBLEM 10
    else:
...
def do_lambda_form(expressions, env):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    body = Pair(expressions.rest,nil)
